...
function _plCardHTML(contact) {
  ...
  <div class="pcard" id="pcard-${contact.id}"
    ...
    <div style="padding-left:6px">
      ...
      ${contact.canal_acquisition ? `<div class="pcard-web-badge">🌐 ${escapeHtml(contact.canal_acquisition)}</div>` : ''}
...
function _plContractDetailHTML(ct, idx, contactId) {
  ...
  const btnLabel = ['prospect','devis_envoye'].includes(col) ? 'Modifier / Envoyer' : 'Voir le contrat';

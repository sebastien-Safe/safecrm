...
const HELP_VIEWS_DATA = {
  ...
  agenda: {
    ...
    icon: '📅',
    roles: 'all',
    description: 'L\'Agenda affiche vos tâches et RDV sous forme de calendrier mensuel. Il se synchronise avec Google Calendar et Apple Calendar via un flux iCal personnel. La prise de RDV en ligne se fait désormais via votre planning de rendez-vous Google Calendar.',
    sections: [
      {
        ...
        items: [
          ...
          'Lien de réservation en ligne (planning Google Calendar) à partager aux prospects',
        ],
      },
    ],
    steps: [
      ...
      { title: 'Renseigner votre lien Google Calendar', content: 'Dans Google Calendar, créez un planning de rendez-vous ("Créer" → "Rendez-vous"), puis copiez son lien de partage ou son code d\'intégration. Cliquez sur ⚙️ en haut de l\'agenda CRM, collez ce lien dans le champ prévu, puis "Enregistrer". Vos disponibilités sont désormais gérées directement dans Google Calendar.' },
      { title: 'Partager votre lien de réservation', content: 'Dans la fenêtre ⚙️, copiez votre lien de réservation S@FE et partagez-le dans vos emails (ex. : signature, email rapport audit). Les prospects réservent directement dans votre planning Google Calendar.' },
      { title: 'Recevoir et gérer les réservations', content: 'Les réservations et notifications sont gérées par Google Calendar (email de confirmation, ajout automatique à votre agenda Google). Elles n\'apparaissent pas automatiquement dans l\'agenda CRM — consultez votre Google Calendar pour le suivi.' },
    ],
    errors: [
      ...
      { q: 'Mon lien de réservation affiche "Lien invalide"', a: 'Vérifiez que le lien collé dans les réglages ⚙️ commence bien par https://calendar.google.com/calendar/appointments/schedules/ — c\'est l\'URL de votre planning de rendez-vous Google Calendar, pas l\'URL de votre agenda classique.' },
    ],
